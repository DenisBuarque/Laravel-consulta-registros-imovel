...
class FinanceController extends Controller
{
    ...
    {
        return view('consultations.transfer.finance.index');
    }
    ...
    public function store(Request $request, UtilsRepositoryInterface $utils)
    {
        ...
        return view('consultations.transfer.finance.calculate', compact(
            ['venal_value','portion','itbi_value','iptu_debit','debit_condominium','registration_fee','onus_certificate','fees','investiment_value','deed_fee','clients','imovels']
        ));
    }
