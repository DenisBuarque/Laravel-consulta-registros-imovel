        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <a href="{{ route('receipt.index') }}">Lista de Recibos</a> cadastrados
                    @can('create-data')
                        <a href="{{ route('receipt.create') }}" class="pull-right">Adicionar Registro</a>
                    @endcan
                </div>
                                ...
                                @forelse($receipts as $key => $value)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @can('update-data')
                                                <a href="{{ route('receipt.pdfreceipt', $value->id) }}" target="_blank" class="btn btn-xs btn-success">
                            ...
                            <div class="modal-dialog modal-sm" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="POST" action="{{ route('receipt.delete', $value->id) }}">
