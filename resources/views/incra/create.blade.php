    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                Formulário de cadstro própriedade rural:
                <a href="{{ route('incra.index') }}" class="pull-right">Lista de registros</a>
                </div>

                <div class="panel-body">
                    <form method="POST" action="{{ route('incra.store') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input type="text" name="denominacao" value="{{ old('denominacao') ? old('denominacao') : '' }}" class="form-control" maxlength="255">
                            </div>
                            <div class="col-md-4 form-group">
                                <label for="localization">*  Indicação para localização do imovel:</label>
                                <input type="text" name="localization" value="{{ old('localization') ? old('localization') : '' }}" class="form-control" maxlength="255">
                            </div>
                            <div class="col-md-2 form-group">
                                <label for="total_area">* Área total:</label>
                                <input type="text" name="total_area" value="{{ old('total_area') ? old('total_area') : '' }}" class="form-control" maxlength="10" placeholder='(ha)' onkeypress='return onlynumber();'>
                            </div>
                            <div class="col-md-4 form-group">
                                <label for="county">* Municipio sede de localização:</label>
                                <input type="text" name="county" value="{{ old('county') ? old('county') : '' }}" class="form-control" maxlength="100">
                            </div>
                            <div class="col-md-4 form-group">
                                <label for="zona">* Área localizada em zona urbana:</label>
                                <input type="text" name="zona" value="{{ old('zona') ? old('zona') : '' }}" class="form-control" maxlength="10" placeholder='(ha)'>
                            </div>
                            <div class="col-md-2 form-group">
                                <label for="state">* Estado sede:</label>
                                <input type="text" name="state" value="{{ old('state') ? old('state') : '' }}" class="form-control" maxlength="2">
                            </div>
                            <div class="col-md-4 form-group">
                                <label for="latitude">Latitude:</label>
                                <input type="text" name="latitude" value="{{ old('latitude') ? old('latitude') : '' }}" class="form-control" maxlength="30">
                            </div>
                            <div class="col-md-4 form-group">
                                <label for="logitude">Longitude:</label>
                                <input type="text" name="logitude" value="{{ old('logitude') ? old('logitude') : '' }}" class="form-control" maxlength="30">
                            </div>
                            <div class="col-md-4 form-group">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="division_country" value="{{ old('division_country') ? old('division_country') : '' }}" class="form-control" maxlength="255" placeholder="Informe o(s) município(s):">
                            </div>
                            <div class="col-md-6 form-group">
                                <label for="destiny">* Destinação do imóvel rural :</label>
                                <input type="text" name="destiny" value="{{ old('destiny') ? old('destiny') : '' }}" class="form-control" maxlength="255">
                            </div>
                            <div class="col-md-2 form-group p-g">
                                <input type="text" name="dismemberment_area" value="{{ old('dismemberment_area') ? old('dismemberment_area') : '' }}" class="form-control" maxlength="10" placeholder="(ha)">
                            </div>
                            <div class="col-md-10 form-group p-g-txt">
                                Informe o total da área desmembrada do imóvel se ocorreu demembramento.
                            </div>
                            <div class="col-md-2 form-group p-g">
                                <input type="text" name="anexo_area" value="{{ old('anexo_area') ? old('anexo_area') : '' }}" class="form-control" maxlength="10" placeholder="(ha)">
                            </div>
                            <div class="col-md-10 form-group p-g-txt">
                                Informe a área de remembramento se correu anexação de área ao imovel rural.
                            </div>
                            <div class="col-md-2 form-group p-g">
                                <input type="text" name="area_add" value="{{ old('area_add') ? old('area_add') : '' }}" class="form-control" maxlength="10" placeholder="(ha)">
                            </div>
                            <div class="col-md-10 form-group p-g-txt">
                                Informa a área de remembramento se ocorreu anexação NÃO cadastrado no imovel rural.
                            </div>
                            <div class="col-md-2 form-group p-g">
                                <input type="number" max='99' min='0' name="amount_family" value="{{ old('amount_family') ? old('amount_family') : '' }}" class="form-control" maxlength="3">
                            </div>
                            <div class="col-md-4 form-group p-g-txt">
                            * Qtd. famílias residentes:
                            </div>
                            <div class="col-md-2 form-group p-g">
                                <input type="number" max='99' min='0' name="amount_people" value="{{ old('amount_people') ? old('amount_people') : '' }}" class="form-control" maxlength="3">
                            </div>
                            <div class="col-md-4 form-group p-g-txt">
                                * Qtd. pessoas residentes:
                            </div>
                            <div class="col-md-2 form-group p-g">
                                <input type="number" max='99' min='0' name="salary_portfolio" value="{{ old('salary_portfolio') ? old('salary_portfolio') : '' }}" class="form-control" maxlength="3">
                            </div>
                            <div class="col-md-4 form-group p-g-txt">
                            ...
                            <div class="col-md-2 form-group p-g">
                            <input type="number" max='99' min='0' name="salary_not" value="{{ old('salary_not') ? old('salary_not') : '' }}" class="form-control" maxlength="3">
                            </div>
                            <div class="col-md-4 form-group p-g-txt">
                                * Assalariados permanentes SEM carteira assinada:
                            </div>
                            <div class="col-md-2 form-group p-g">
                                <input type="number" max='99' min='0' name="family_labor" value="{{ old('family_labor') ? old('family_labor') : '' }}" class="form-control" maxlength="3">
                            </div>
                            <div class="col-md-4 form-group p-g-txt">
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <input type="text" name="used_area" value="{{ old('use_area') ? old('use_area') : '' }}" class="form-control" maxlength="100" placeholder="(ha)">
                            </div>
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <input type="number" max='9999' min='0' name="amount_animal" value="{{ old('amount_animal') ? old('amount_animal') : '' }}" class="form-control" maxlength="3">
                            </div>
