    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                Formulário editar dados pessoa jurídica
                <a href="{{ route('clients.index') }}" class="pull-right">Lista de Registros</a>
                </div>

                <div class="panel-body">

                    <form method="POST" action="{{ route('clients.juridic.update', $client->id) }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 form-group">
                                ...
                                <input type="text" name="company" value="{{ old('company') ? old('company') : $client->company }}" class="form-control" id="company" maxlength="256">
                            </div>
                            <div class="col-md-4 form-group">
                                <label for="cnpj">* CNPJ:</label>
                                <input type="text" name="cnpj" value="{{ old('cnpj') ? old('cnpj') : $client->cnpj }}" class="form-control" id="cnpj" maxlength="18" onKeyPress="return formatCnpj(this, event)">
                            </div>
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <input type="text" name="cep" value="{{ old('cep') ? old('cep') : $client->cep }}" class="form-control" id="cep" maxlength="9" placeholder="Opcional" onKeyPress="return formatCep(this, event)">
                            </div>
                            <div class="col-md-3 form-group">
                            ...
                            <div class="col-md-8 form-group">
                                ...
                                <input type="email" name="email" value="{{ old('email') ? old('email') : $client->email }}" class="form-control" id="email" maxlength="100" placeholder="Opcional">
                            </div>
