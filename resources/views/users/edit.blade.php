                    ...
                    <form method="POST" action="{{ route('users.update', $user->id) }}">
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group">
                                ...
                                <input type="text" name="name" value="{{ old('name') ? old('name') : $user->name }}" class="form-control" id="name" maxlength="50" autofocus>
                            </div>
                            <div class="col-md-12 form-group">
                                <label for="email">* email:</label>
                                <input type="email" name="email" value="{{ old('email') ? old('email') : $user->email }}" class="form-control" id="email" maxlength="100">
                            </div>
                            <div class="col-md-12 form-group">
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <input type="password" name="password" class="form-control" id="email" maxlength="10">
                            </div>
                            <div class="col-md-12 form-group">
