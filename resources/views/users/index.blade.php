        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <a href="{{ route('users.index') }}">Lista de Usuários</a> cadastrados
                    @can('create-data')
                        <a href="{{ route('users.create') }}" class="pull-right">Adicionar Registro</a>
                    @endcan
                </div>
                ...
                <div class="panel-body">
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            @forelse($users as $key => $value)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @can('update-data')
                                            <a href="{{ route('users.edit', $value->id) }}" class="btn btn-xs btn-success">
                            ...
                            @empty
                                <tr>
                                    <td colspan="2">Nenum registro encontrado</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
